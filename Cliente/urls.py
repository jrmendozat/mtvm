...
urlpatterns = patterns('',
    ...
    url(r'^email/(?P<id_cli>\d+)/delete/(?P<pk>\d+)$', views.delete_email, \
        name='delete_email'),
    url(r'^direccion/(?P<id_cli>\d+)/nuevo$', views.add_direccion_cliente, \
        name = 'add_direccion_cliente'),
    ...
    url(r'^cliente_ficha/(?P<id_cli>\d+)/direccion/editar/(?P<pk>\d+)/$', views.direccion_cliente_edit, \
        name = 'direccion_cliente_edit'),
    url(r'^cliente_ficha/(?P<id_cli>\d+)/direccion/nuevo', views.add_direccion_cliente, \
        name = 'add_direccion_cliente'),
